/**
  * Class representing a media template.
 */
class MediaTemplate {
  /**
  ...
  createMediaCardDOM () {
    ...
    $emptyHeartIcon.setAttribute('aria-hidden', 'true')
    $emptyHeartIcon.setAttribute('width', '24')
    $emptyHeartIcon.setAttribute('height', '24')
 ...
 */
  createMediaThumbnail () {
    ...
    // Add the media ID as a class to the figure element to be able to select it when a user will like a media
